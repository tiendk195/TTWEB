        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="#" class="dropdown-item">Hoạt Động </a></li>
              <li><a href="#" class="dropdown-item">Hoạt Động Gần Đây</a></li>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="text-sm">Gọi cho tôi bất cứ khi nào bạn có thể...</p>
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <p class="text-sm">Có tin nhắn mới</p>
                  <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 Tiếng Trước</p>
                </div>
              </div>
              <!-- Message End -->
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <div class="dropdown-divider"></div>
            <a href="#" class="dropdown-item">
              <i class="fas fa-users mr-2"></i> 8 Đề Xuất Bạn Bè
