                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                            <?php if($row['status'] == 0): ?>
                                                <span class="badge badge-light text-dark border px-3 rounded-pill">Đang Đóng Hàng</span>
                                            <?php elseif($row['status'] == 1): ?>
                                                <span class="badge badge-primary px-3 rounded-pill">Đã Đóng Gói</span>
                                            <?php elseif($row['status'] == 2): ?>
                                                <span class="badge badge-warning px-3 rounded-pill">Đang Giao</span>
